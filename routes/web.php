...
Route::name('llamadorTurnero')->get('/llamador/{id_s}/{dni}/{totem}', 'GeneradorController@llamadorTurnero');
Route::name('ticket')->get('/ticket/{id_s}/{dni}/{cat}/{totem}', 'GeneradorController@ticket');
