    ...
    <div class="col-md-8">
      ...
      <div class="card">
        <div class="card-header bg-gradient-success">
          <h3 class="card-title">Orden Médica Electrónica - Solicitud de recetario {{$afiliado->autorizacion}}</h3>
        </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group row" id="ocultar3" style="visibility: {{$afiliado->oculto}}">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Detalle</label>
                      <textarea required id="detalle_input" name="detalle" title="Se necesita un nombre"  placeholder="Indicar motivo de la generación del recetario" class="form-control"></textarea>
                    </div>
                  </div>
                ...
                <div class="form-group row" id="ocultar4" style="visibility: {{$afiliado->oculto}}">
                  ...
                  <div class="col-sm-12">
                    ...
                    <input type="hidden" class="form-control" value="4" name="tipo_orden">
                    <input type="hidden" class="form-control" value="1" name="copago_id">
                    <input type="hidden" class="form-control" value="1" name="cantidad">
                    <input type="hidden" class="form-control" value="0" name="precio">
                    <input type="hidden" class="form-control" value="{{ $afiliado->nro_doc }}" name="id_afiliado">
                  </div>
                  <div class="card-footer" id="ocultar5" style="visibility: {{$afiliado->oculto}}">
