    ...
    <div class="col-md-8">
      ...
      <div class="card">
        <div class="card-header bg-gradient-success">
          <h3 class="card-title">Orden Médica Electrónica - Solicitud de Practicas {{$afiliado->autorizacion}}</h3>
        </div>
              ...
              <div class="card-body">
                ...
                <hr>
                  ...
                  <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Generar Practica</button>
                  </div>
