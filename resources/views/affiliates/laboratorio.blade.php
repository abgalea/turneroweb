...
header h1 { background: rgb(216, 216, 216); border-radius: 0.25em; color: rgb(0, 0, 0); margin: 0 0 1em; padding: 0.5em 0; }
	...
	<body>
		...
		<header>
			...
			<fechas style="margin: 10 50px 0 0" >
				<p>ORDEN NRO: {{str_pad($orden->id, 5, "0", STR_PAD_LEFT)}}<br>
		...
		<article>
			...
			<div  style="margin: -19px;">
				<table class="table table-borderless" style="margin: 0 0 -10px 20px;">
					<tr><td><span>EFECTOR:</span></td></tr>
					<tr><td><span>PROFESIONAL:</span></td></tr>
					<tr><td><span>ESPECIALIDAD:</span></td></tr>
				</table>
				<br>
				...
				<table class="table table-borderless" style="margin: 0 0 -10px 20px; border-top: solid 1px; border-bottom: solid 1px;">
					...
					<tr>
						<td colspan="3"><span>{{$practica_solicitada->detalle}}</span></td>
						{{-- <td><span>{{$orden->cantidad}}</span></td> --}}
					</tr>    
                    @endforeach
				</table>
